...
<body>
    ...
    <div class="editbtn_container">
        <a href="edit-profile.php"><button type="submit" class="editbtn" id="edit" value="Edit Profile">Edit
                Profile</button></a>
    </div>
    <br />
    <div class="bookhistorybtn_container">
        <a href="view_bookingHistory.php"><button type="submit" class="viewhistory" id="history"
                value="View Booking History">View Booking History</button></a>
    </div>
    <br />
    <div class="refundbtn_container">
        <a href="refund.php"><button type="submit" class="refundbtn" id="refund" value="Request Refund">Request
                Refund</button></a>
    </div>
</body>
