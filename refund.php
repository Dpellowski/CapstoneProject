...
<body>
    ...
    <div class="goback_history">
        <a href="view_bookingHistory.php"><button type="submit" class="history" id="history"
                value="Go Back to Booking History">Go back to Booking History</button></a>
    </div>
    <br />
    <table>
        <tr class="title">
    ...
    <div class="submitbtn_container">
        <a href="#request"><button type="submit" class="submit_request" id="submit_request"
                value="Submit request">Submit request</button></a>
    </div>
    <br />
